...
/* Define to 1 if you have the ZeroMQ library (-lzmq). */
...
/* Define to 1 if the x3zmq plugin is enabled. */
#define HAVE_PLUGIN_X3ZMQ 1
...
#define LT_DLSEARCH_PATH "/lib:/usr/lib:/usr/lib/libfakeroot:/usr/lib/perl5/core_perl/CORE:/usr/lib/xulrunner-9.0.1"
...
#define PACKAGE_STRING "collectd 5.0.2.git"
...
#define PACKAGE_VERSION "5.0.2.git"

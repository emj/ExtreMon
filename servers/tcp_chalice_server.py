...
class TCPChaliceRequestHandler(BaseRequestHandler):
	def setup(self):
		self.outq=Queue()
		self.running=True
...
class TCPChaliceServer(ChaliceServer,ThreadingTCPServer):
...
class TCPChaliceDispatcher:
	def __init__(self,mcast_addr,listen,prefix):
		self.server=TCPChaliceServer(listen,prefix)
...
if __name__=='__main__':
	...
	TCPChaliceDispatcher(mcast_addr=('224.0.0.1',1248),listen=(listen_addr,listen_port),prefix=prefix)
